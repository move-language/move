...
module std::fixed_point32 {
    ...
    public fun multiply_u64(val: u64, multiplier: FixedPoint32): u64 {
        ...
        assert!(product <= MAX_U64, errors::out_of_range());
        (product as u64)
    }
    spec multiply_u64 {
        pragma opaque;
    ...
    public fun divide_u64(val: u64, divisor: FixedPoint32): u64 {
        ...
        assert!(divisor.value != 0, errors::out_of_range());
        // First convert to 128 bits and then shift left to
        // add 32 fractional zero bits to the dividend.
        let scaled_value = (val as u128) << 32;
        let quotient = scaled_value / (divisor.value as u128);
        // Check whether the value is too large.
        assert!(quotient <= MAX_U64, errors::out_of_range());
    ...
    public fun create_from_rational(numerator: u64, denominator: u64): FixedPoint32 {
        ...
        assert!(scaled_denominator != 0, errors::out_of_range());
        let quotient = scaled_numerator / scaled_denominator;
        assert!(quotient != 0 || numerator == 0, errors::out_of_range());
    ...
    spec schema CreateFromRationalAbortsIf {
        ...
        let quotient = scaled_numerator / scaled_denominator;
        aborts_if scaled_denominator == 0 with errors::OUT_OF_RANGE;
        aborts_if quotient == 0 && scaled_numerator != 0 with errors::OUT_OF_RANGE;
        aborts_if quotient > MAX_U64 with errors::OUT_OF_RANGE;
    }
