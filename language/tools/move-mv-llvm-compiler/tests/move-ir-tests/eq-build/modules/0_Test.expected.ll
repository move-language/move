...
entry:
  ...
  %icmp_src_0 = load i8, ptr %local_2, align 1
  %icmp_src_1 = load i8, ptr %local_3, align 1
  %icmp_dst = icmp eq i8 %icmp_src_0, %icmp_src_1
  store i1 %icmp_dst, ptr %local_4, align 1
