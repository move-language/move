...
impl<'a, T: MoveResolver + ?Sized> MoveValueAnnotator<'a, T> {
    ...
    fn annotate_value(&self, value: &MoveValue, ty: &FatType) -> Result<AnnotatedMoveValue> {
        Ok(match (value, ty) {
            ...
            (MoveValue::U8(_), FatType::Bool)
            | (MoveValue::U8(_), FatType::U64)
            | (MoveValue::U8(_), FatType::U128)
            | (MoveValue::U8(_), FatType::Address)
            | (MoveValue::U8(_), FatType::Signer)
            | (MoveValue::U8(_), FatType::Vector(_))
            | (MoveValue::U8(_), FatType::Struct(_))
            | (MoveValue::U8(_), FatType::Reference(_))
            | (MoveValue::U8(_), FatType::MutableReference(_))
            | (MoveValue::U8(_), FatType::TyParam(_))
            | (MoveValue::U8(_), FatType::U16)
            | (MoveValue::U8(_), FatType::U32)
            | (MoveValue::U8(_), FatType::U256)
            | (MoveValue::U64(_), FatType::Bool)
            | (MoveValue::U64(_), FatType::U8)
            | (MoveValue::U64(_), FatType::U128)
            | (MoveValue::U64(_), FatType::Address)
            | (MoveValue::U64(_), FatType::Signer)
            | (MoveValue::U64(_), FatType::Vector(_))
            | (MoveValue::U64(_), FatType::Struct(_))
            | (MoveValue::U64(_), FatType::Reference(_))
            | (MoveValue::U64(_), FatType::MutableReference(_))
            | (MoveValue::U64(_), FatType::TyParam(_))
            | (MoveValue::U64(_), FatType::U16)
            | (MoveValue::U64(_), FatType::U32)
            | (MoveValue::U64(_), FatType::U256)
            | (MoveValue::U128(_), FatType::Bool)
            | (MoveValue::U128(_), FatType::U8)
            | (MoveValue::U128(_), FatType::U64)
            | (MoveValue::U128(_), FatType::Address)
            | (MoveValue::U128(_), FatType::Signer)
            | (MoveValue::U128(_), FatType::Vector(_))
            | (MoveValue::U128(_), FatType::Struct(_))
            | (MoveValue::U128(_), FatType::Reference(_))
            | (MoveValue::U128(_), FatType::MutableReference(_))
            | (MoveValue::U128(_), FatType::TyParam(_))
            | (MoveValue::U128(_), FatType::U16)
            | (MoveValue::U128(_), FatType::U32)
            | (MoveValue::U128(_), FatType::U256)
            | (MoveValue::Bool(_), FatType::U8)
            | (MoveValue::Bool(_), FatType::U64)
            | (MoveValue::Bool(_), FatType::U128)
            | (MoveValue::Bool(_), FatType::Address)
            | (MoveValue::Bool(_), FatType::Signer)
            | (MoveValue::Bool(_), FatType::Vector(_))
            | (MoveValue::Bool(_), FatType::Struct(_))
            | (MoveValue::Bool(_), FatType::Reference(_))
            | (MoveValue::Bool(_), FatType::MutableReference(_))
            | (MoveValue::Bool(_), FatType::TyParam(_))
            | (MoveValue::Bool(_), FatType::U16)
            | (MoveValue::Bool(_), FatType::U32)
            | (MoveValue::Bool(_), FatType::U256)
            | (MoveValue::Address(_), FatType::Bool)
            | (MoveValue::Address(_), FatType::U8)
            | (MoveValue::Address(_), FatType::U64)
            | (MoveValue::Address(_), FatType::U128)
            | (MoveValue::Address(_), FatType::Signer)
            | (MoveValue::Address(_), FatType::Vector(_))
            | (MoveValue::Address(_), FatType::Struct(_))
            | (MoveValue::Address(_), FatType::Reference(_))
            | (MoveValue::Address(_), FatType::MutableReference(_))
            | (MoveValue::Address(_), FatType::TyParam(_))
            | (MoveValue::Address(_), FatType::U16)
            | (MoveValue::Address(_), FatType::U32)
            | (MoveValue::Address(_), FatType::U256)
            | (MoveValue::Vector(_), FatType::Bool)
            | (MoveValue::Vector(_), FatType::U8)
            | (MoveValue::Vector(_), FatType::U64)
            | (MoveValue::Vector(_), FatType::U128)
            | (MoveValue::Vector(_), FatType::Address)
            | (MoveValue::Vector(_), FatType::Signer)
            | (MoveValue::Vector(_), FatType::Struct(_))
            | (MoveValue::Vector(_), FatType::Reference(_))
            | (MoveValue::Vector(_), FatType::MutableReference(_))
            | (MoveValue::Vector(_), FatType::TyParam(_))
            | (MoveValue::Vector(_), FatType::U16)
            | (MoveValue::Vector(_), FatType::U32)
            | (MoveValue::Vector(_), FatType::U256)
            | (MoveValue::Struct(_), FatType::Bool)
            | (MoveValue::Struct(_), FatType::U8)
            | (MoveValue::Struct(_), FatType::U64)
            | (MoveValue::Struct(_), FatType::U128)
            | (MoveValue::Struct(_), FatType::Address)
            | (MoveValue::Struct(_), FatType::Signer)
            | (MoveValue::Struct(_), FatType::Vector(_))
            | (MoveValue::Struct(_), FatType::Reference(_))
            | (MoveValue::Struct(_), FatType::MutableReference(_))
            | (MoveValue::Struct(_), FatType::TyParam(_))
            | (MoveValue::Struct(_), FatType::U16)
            | (MoveValue::Struct(_), FatType::U32)
            | (MoveValue::Struct(_), FatType::U256)
            | (MoveValue::Signer(_), FatType::Bool)
            | (MoveValue::Signer(_), FatType::U8)
            | (MoveValue::Signer(_), FatType::U64)
            | (MoveValue::Signer(_), FatType::U128)
            | (MoveValue::Signer(_), FatType::Address)
            | (MoveValue::Signer(_), FatType::Signer)
            | (MoveValue::Signer(_), FatType::Vector(_))
            | (MoveValue::Signer(_), FatType::Struct(_))
            | (MoveValue::Signer(_), FatType::Reference(_))
            | (MoveValue::Signer(_), FatType::MutableReference(_))
            | (MoveValue::Signer(_), FatType::TyParam(_))
            | (MoveValue::Signer(_), FatType::U16)
            | (MoveValue::Signer(_), FatType::U32)
            | (MoveValue::Signer(_), FatType::U256)
            | (MoveValue::U16(_), FatType::Bool)
            | (MoveValue::U16(_), FatType::U8)
            | (MoveValue::U16(_), FatType::U64)
            | (MoveValue::U16(_), FatType::U128)
            | (MoveValue::U16(_), FatType::Address)
            | (MoveValue::U16(_), FatType::Signer)
            | (MoveValue::U16(_), FatType::Vector(_))
            | (MoveValue::U16(_), FatType::Struct(_))
            | (MoveValue::U16(_), FatType::Reference(_))
            | (MoveValue::U16(_), FatType::MutableReference(_))
            | (MoveValue::U16(_), FatType::TyParam(_))
            | (MoveValue::U16(_), FatType::U32)
            | (MoveValue::U16(_), FatType::U256)
            | (MoveValue::U32(_), FatType::Bool)
            | (MoveValue::U32(_), FatType::U8)
            | (MoveValue::U32(_), FatType::U64)
            | (MoveValue::U32(_), FatType::U128)
            | (MoveValue::U32(_), FatType::Address)
            | (MoveValue::U32(_), FatType::Signer)
            | (MoveValue::U32(_), FatType::Vector(_))
            | (MoveValue::U32(_), FatType::Struct(_))
            | (MoveValue::U32(_), FatType::Reference(_))
            | (MoveValue::U32(_), FatType::MutableReference(_))
            | (MoveValue::U32(_), FatType::TyParam(_))
            | (MoveValue::U32(_), FatType::U16)
            | (MoveValue::U32(_), FatType::U256)
            | (MoveValue::U256(_), FatType::Bool)
            | (MoveValue::U256(_), FatType::U8)
            | (MoveValue::U256(_), FatType::U64)
            | (MoveValue::U256(_), FatType::U128)
            | (MoveValue::U256(_), FatType::Address)
            | (MoveValue::U256(_), FatType::Signer)
            | (MoveValue::U256(_), FatType::Vector(_))
            | (MoveValue::U256(_), FatType::Struct(_))
            | (MoveValue::U256(_), FatType::Reference(_))
            | (MoveValue::U256(_), FatType::MutableReference(_))
            | (MoveValue::U256(_), FatType::TyParam(_))
            | (MoveValue::U256(_), FatType::U16)
            | (MoveValue::U256(_), FatType::U32) => {
                return Err(anyhow!(
