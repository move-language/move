...
pub fn report_diagnostics(files: &FilesSourceText, diags: Diagnostics, should_exit: bool) {
...
pub fn result_or_report_diagnostics<T>(
    ...
    match res {
        ...
        Err(diags) => {
            ...
            report_diagnostics(files, diags, should_exit);
            None
        }
    }
}
