...
impl ValueImpl {
    fn equals(&self, other: &Self) -> PartialVMResult<bool> {
        ...
        let res = match (self, other) {
            ...
            | (Invalid, Address(_))
            | (Invalid, Container(_))
            | (Invalid, ContainerRef(_))
            | (Invalid, IndexedRef(_))
            | (U8(_), Invalid)
            | (U8(_), U16(_))
            | (U8(_), U32(_))
            | (U8(_), U64(_))
            ...
            | (Address(_), U256(_))
            | (Address(_), Bool(_))
            | (Address(_), Container(_))
            | (Address(_), ContainerRef(_))
            | (Address(_), IndexedRef(_))
            | (Container(_), Invalid)
            | (Container(_), U8(_))
            | (Container(_), U16(_))
            | (Container(_), U32(_))
            ...
            | (Container(_), U256(_))
            | (Container(_), Bool(_))
            | (Container(_), Address(_))
            | (Container(_), ContainerRef(_))
            | (Container(_), IndexedRef(_))
            | (ContainerRef(_), Invalid)
            | (ContainerRef(_), U8(_))
            | (ContainerRef(_), U16(_))
            | (ContainerRef(_), U32(_))
            | (ContainerRef(_), U64(_))
            | (ContainerRef(_), U128(_))
            | (ContainerRef(_), U256(_))
            | (ContainerRef(_), Bool(_))
            | (ContainerRef(_), Address(_))
            | (ContainerRef(_), Container(_))
            | (ContainerRef(_), IndexedRef(_))
            | (IndexedRef(_), Invalid)
            | (IndexedRef(_), U8(_))
            | (IndexedRef(_), U16(_))
            | (IndexedRef(_), U32(_))
            | (IndexedRef(_), U64(_))
            ...
            | (IndexedRef(_), U256(_))
            | (IndexedRef(_), Bool(_))
            | (IndexedRef(_), Address(_))
            | (IndexedRef(_), Container(_))
            | (IndexedRef(_), ContainerRef(_)) => {
