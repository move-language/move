...
\author{
  David Dill \and Wolfgang Grieskamp$^{\textrm{\textifsymbol{0}}}$\thanks{\mailname \email{wgrieskamp@gmail.com}} \and \\ Junkil
...
\Paragraph{Open Access} This chapter is licensed under the terms of the Creative Commons
